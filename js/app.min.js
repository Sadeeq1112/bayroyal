...
document.querySelector('.scroll-arrows').addEventListener('click', function() {
  var nextSection = this.parentElement.nextElementSibling;
  if (nextSection) {
    nextSection.scrollIntoView({ behavior: 'smooth' });
  }
});

var slides = document.querySelectorAll('.new-slide');
var currentSlide = 0;
var slideInterval = setInterval(nextSlide,3000); // Change slide every 3 seconds

function nextSlide() {
    slides[currentSlide].className = 'new-slide';
    currentSlide = (currentSlide+1)%slides.length;
    slides[currentSlide].className = 'new-slide showing';
}